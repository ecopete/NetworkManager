...
static const guint8 _supported_cache_ids_qdisc[] = {
	NMP_CACHE_ID_TYPE_OBJECT_TYPE,
	NMP_CACHE_ID_TYPE_ADDRROUTE_BY_IFINDEX,
	0,
};

static const guint8 _supported_cache_ids_tfilter[] = {
	NMP_CACHE_ID_TYPE_OBJECT_TYPE,
	NMP_CACHE_ID_TYPE_ADDRROUTE_BY_IFINDEX,
	0,
};
...
const NMPClass _nmp_classes[NMP_OBJECT_TYPE_MAX] = {
	...
	[NMP_OBJECT_TYPE_QDISC - 1] = {
		...
		.supported_cache_ids                = _supported_cache_ids_qdisc,
	...
	[NMP_OBJECT_TYPE_TFILTER - 1] = {
		...
		.supported_cache_ids                = _supported_cache_ids_tfilter,
